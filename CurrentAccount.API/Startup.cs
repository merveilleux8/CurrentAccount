...
using CurrentAccount.Service;
using CurrentAccount.Service.Impl;
...
namespace CurrentAccount.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IMemoryCache memoryCache)
        {
            ...
            memoryCache.Set("accounts", new List<Account>(), entryOptions);
            memoryCache.Set("transactions", new List<Transaction>(), entryOptions);
        }
    }
}
